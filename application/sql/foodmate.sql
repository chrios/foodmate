...
ALTER TABLE `list`
ADD CONSTRAINT `fk_list_unit_list1` FOREIGN KEY (`unit_id`) REFERENCES `unit` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_list_user_list1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_list_ingredient_list1` FOREIGN KEY (`ingredient_id`) REFERENCES `ingredient` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
--
...
ALTER TABLE `list`
ADD KEY `fk_list_unit_list1_idx` (`unit_id`),
ADD KEY `fk_list_user_list1_idx` (`user_id`),
ADD KEY `fk_list_ingredient_list1_idx` (`ingredient_id`);
